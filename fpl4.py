...
def llm_generate(prompt: str, model="openai/gpt-oss-20b:free"):
...
def userQueryKG(userQuery : str, preprocessor : FPLInputPreprocessor, model="openai/gpt-oss-20b:free", traceQuery=False):
    ...
    if run_button and query:
        with st.spinner("Processing query..."):
            try:
                ...
                # Optionally show KG data and debug info
                if show_kg_data:
